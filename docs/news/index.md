...
This version provides a stable, production-oriented interface for
interacting with MinIO object storage from R, with a focus on explicit
APIs, robust error handling, and data engineering workflows.
...
- All public functions fail fast with explicit and informative error
  messages.
...
- Minimal abstraction over S3-compatible APIs, optimized for MinIO
  workflows.
